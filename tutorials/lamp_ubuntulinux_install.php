...
?>
   <div class='container' id="wrapper">
     ...
     <p>According to <a href='https://en.wikipedia.org/wiki/Apache_HTTP_Server'>Wikipedia</a>: The Apache HTTP Server,
      ...
      <pre>
	<code class='code-box'>sudo apt-get update</code>
      </pre>
	...
	<code class='code-box'>sudo apt-get install mysql</code>
       ...
       <p>d) Install php</p>
       <pre>
	<code class='code-box'>sudo apt-get install php5 libapache2-mod-php5 php5-mcrypt</code>
       </pre>
	...
	<code class='code-box'>sudo systemctl start apache2</code>
       ...
       <pre>
	<code class='code-box'>sudo systemctl status apache2</code>
       </pre>
